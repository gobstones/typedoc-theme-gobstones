...
/**
 * Return an element that contains the SVG for the icon used by the kind of
 * an element, such as the icon to use for classes, the one used by functions
 * and so on.
 *
 * @param letterPath - The svg element that represents the letter to showcase inside the icon.
 * @param color - The color to use as outline of this icon.
 * @param circular - Whether to display this as a circular icon (if not, squared is default).
 *
 * @returns An SVG.Element with the SVG icon.
 */
const kindIcon = (letterPath: JSX.Element, color: string, circular = false): JSX.Element => (
 ...
 */
export const buildRefIcons = <T extends Record<string, () => JSX.Element>>(
    icons: T,
...
/**
 * A record of all possible reflection kinds along with a function that
 * returns it's associated icon.
 */
